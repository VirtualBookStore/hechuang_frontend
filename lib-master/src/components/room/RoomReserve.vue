      ...
      <el-col :span="14"
        ...
        <el-form ref="roomFormRef"
          ...
          <el-form-item label="自习室ID"
                        prop="room_id">
            <el-input v-model="roomForm.room_id"
                      placeholder="自习室ID"></el-input>
          </el-form-item>
          <el-form-item label="座位ID"
                        prop="seat_id">
            <el-input v-model="roomForm.seat_id"
                      placeholder="座位ID"></el-input>
          </el-form-item>
          ...
          <el-button type="primary"
                     @click="roomreserve"
                     class="submit_btn">提交申请</el-button>
        </el-form>
      </el-col>
    </el-row>
  </div>
